...
<header>
  <section id="header">
    <div class="center">        
      ...
      <div class="menu">
        <div class="item_menu noticias"><a href="<?php print base_path(); ?>noticias">Noticias</a></div>
        ...
        <div class="item_menu promociones"><a href="<?php print base_path(); ?>recomendados">Recomendados</a></div>
